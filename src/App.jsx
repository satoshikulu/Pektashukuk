  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-dark">
        ...
        {/* Blog CTA Section */}
        <section className="py-16 md:py-20 bg-gradient-to-b from-black to-dark relative overflow-hidden">
          {/* Background Pattern */}
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div 
              className="max-w-4xl mx-auto bg-gradient-to-br from-gold/10 to-transparent border-2 border-gold/30 rounded-3xl p-8 md:p-12 backdrop-blur-sm"
              data-aos="fade-up"
            >
              {/* Icon */}
              ...
              {/* Description */}
              <p className="text-center text-gray-300 text-base md:text-lg leading-relaxed mb-8 max-w-3xl mx-auto">
                Her hukuki sorun bir belirsizlik yaratır. Doğru bilgiye ulaşmak ise hem süreçleri kolaylaştırır 
                hem de haklarınızı net şekilde anlamanızı sağlar.
              </p>

              <p className="text-center text-gray-300 text-base md:text-lg leading-relaxed mb-8 max-w-3xl mx-auto">
                <span className="text-gold font-semibold">20 yıllık tecrübemle</span> aile hukuku ve icra hukuku 
                konularında hazırladığım bilgilendirici makaleler, yaşadığınız hukuki durumlara ışık tutacaktır.
              </p>

              {/* Stats */}
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
                <div className="text-center p-4 bg-white/5 rounded-xl">
                  <div className="text-2xl md:text-3xl font-bold text-gold mb-1">10+</div>
                  <div className="text-sm text-gray-400">Detaylı Makale</div>
                </div>
                <div className="text-center p-4 bg-white/5 rounded-xl">
                  <div className="text-2xl md:text-3xl font-bold text-gold mb-1">2</div>
                ...
                <div className="text-center p-4 bg-white/5 rounded-xl col-span-2 md:col-span-1">
                  <div className="text-2xl md:text-3xl font-bold text-gold mb-1">20 Yıl</div>
              ...
              <div className="mt-8 pt-8 border-t border-gold/20">
                <p className="text-center text-sm text-gray-400 mb-4">Popüler Konular:</p>
                <div className="flex flex-wrap justify-center gap-2">
                  <span className="px-3 py-1 bg-white/5 border border-gold/30 rounded-full text-xs text-gray-300">
                    Boşanma Davası
                  </span>
                  <span className="px-3 py-1 bg-white/5 border border-gold/30 rounded-full text-xs text-gray-300">
                    İcra Takibi
